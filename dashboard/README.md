...
Fresh browser interaction and visual validation could not be performed because the browser tool could not verify its enforced security policy. Sequence identity and deterministic rebuild checks pass; they do not substitute for a real-browser test. No data or inference protocol was changed during this portability cleanup.
