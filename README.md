...
- **Evaluation:** average precision, supported pairs in the top 20, interchromosomal results, and component-bootstrap uncertainty. See `results/classifier/metrics.json` and `MODEL_CARD.md` for the actual results and limitations.
