...
3. **Full-dataset integration:** inspect the other task’s completed outputs and provenance before changing any scientific claim. A reviewed release of the current evidence workflow is prepared with an exact source manifest and clean-bundle validation. Keep a usable release available if the full analysis is incomplete at its cutoff.
