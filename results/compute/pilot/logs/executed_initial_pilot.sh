...
curl -fL --retry 2 --max-time 600 https://ftp-trace.ncbi.nlm.nih.gov/sra/sdk/current/sratoolkit.current-ubuntu64.tar.gz -o tools/sratoolkit.tar.gz
mkdir -p tools/sra
